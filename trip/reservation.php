...
<body>
	<header>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  			<a class="navbar-brand m" href="#"><img src="imgs/logo2.jpg" class="aw"></a>
                       ...
                       <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <?php 
                           ...
                           ?>
                         <?php echo '<select class="form-control" name="package">
                             <option value="'.$row['pid'].'">'.$row['pname'].'</option></select>';?>
                           <?php 
                            }
                            }   
                            ?>                  
